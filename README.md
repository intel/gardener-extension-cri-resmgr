...
```
kubectl apply -f ~/work/gardener-extension-cri-resmgr/examples/ctrldeploy-ctrlreg.yaml
```
...
```
make docker-images
kind load docker-image gardener-extension-cri-resmgr:latest --name gardener-local
kind load docker-image gardener-extension-cri-resmgr-installation:latest --name gardener-local
```


```
kubectl apply -f ~/work/gardener-extension-cri-resmgr/examples/shoot.yaml
```
